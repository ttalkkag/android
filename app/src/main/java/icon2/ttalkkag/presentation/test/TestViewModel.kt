...
import icon2.ttalkkag.util.network.onError
import icon2.ttalkkag.util.network.onException
import icon2.ttalkkag.util.network.onFail
import icon2.ttalkkag.util.network.onSuccess
